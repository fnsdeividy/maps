...
INSERT INTO "new_MapaReport" (
    "approvedAt", "avg24hDiastolic", "avg24hSystolic", "awakeDiastolic", "awakeDiastolicLoad", "awakeSystolic", "awakeSystolicLoad", "createdAt", "currentMedications", "diastolicNightDipping", "examDate", "generatedConclusion", "generatedGeneralConsiderations", "generatedMedications", "generatedNightDipping", "generatedPressureLoad", "generatedPressurePeaks", "generatedResults", "generatedSpecialSituations", "generatedTechnicalComments", "id", "includeHistogramChart", "includePieChart", "includeTrendChart", "officeDiastolicPressure", "officeHeartRate", "officeSystolicPressure", "patientId", "peakAwake", "peakMorning", "peakPhysicalEmotionalStress", "peakPressureNotes", "peakSleep", "peakWithHeartRateIncrease", "pregnancy", "pregnancyMonths", "sleepDiastolic", "sleepDiastolicLoad", "sleepSystolic", "sleepSystolicLoad", "source", "specialSituations", "status", "systolicNightDipping", "technicalComments", "totalMeasurements", "updatedAt", "usedAiFallback", "validMeasurements", "validMeasurementsPercentage",
    "pregnancyStatus", "alcoholUse", "smoking", "insomnia", "caffeineUse"
)
SELECT
    "approvedAt", "avg24hDiastolic", "avg24hSystolic", "awakeDiastolic", "awakeDiastolicLoad", "awakeSystolic", "awakeSystolicLoad", "createdAt", "currentMedications", "diastolicNightDipping", "examDate", "generatedConclusion", "generatedGeneralConsiderations", "generatedMedications", "generatedNightDipping", "generatedPressureLoad", "generatedPressurePeaks", "generatedResults", "generatedSpecialSituations", "generatedTechnicalComments", "id", "includeHistogramChart", "includePieChart", "includeTrendChart", "officeDiastolicPressure", "officeHeartRate", "officeSystolicPressure", "patientId", "peakAwake", "peakMorning", "peakPhysicalEmotionalStress", "peakPressureNotes", "peakSleep", "peakWithHeartRateIncrease", "pregnancy", "pregnancyMonths", "sleepDiastolic", "sleepDiastolicLoad", "sleepSystolic", "sleepSystolicLoad", "source", "specialSituations", "status", "systolicNightDipping", "technicalComments", "totalMeasurements", "updatedAt", "usedAiFallback", "validMeasurements", "validMeasurementsPercentage",
    CASE WHEN "pregnancy" = 1 THEN 'YES' ELSE 'NO' END,
